...
class Design_22_22_HealthManager extends ActorScript
{
	...
	public var _setcurrentlife:Float;
	public var _x:Float;
	...
	public function _customEvent_Death():Void
	{
		if((_CurrentHealth == 0))
		{
			switchScene(GameModel.get().scenes.get(3).getID(), null, createCrossfadeTransition(0.3));
		}
		else
		{
			reloadCurrentScene(null, createCrossfadeTransition(0.3));
		}
		if(_Spawned)
		{
			return;
	...
	public function new(dummy:Int, actor:Actor, dummy2:Engine)
	{
		...
		_DrawHealthBar = true;
		nameMap.set("set current life", "_setcurrentlife");
		_setcurrentlife = 0.0;
		nameMap.set("x", "_x");
		_x = 0.0;
