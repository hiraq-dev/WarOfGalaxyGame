...
class Design_52_52_MuteButton extends ActorScript
{
	...
	public function _customEvent_ActivateAction():Void
	{
		if(_MuteChannel)
		{
			setVolumeForChannel(0/100, Std.int(_Channel));
		}
		else
		{
	...
	public function _customEvent_DeactivateAction():Void
	{
		if(_MuteChannel)
		{
			setVolumeForChannel(100/100, Std.int(_Channel));
		}
		else
		{
	...
	public function new(dummy:Int, actor:Actor, dummy2:Engine)
	{
		...
		_Channel = 0.0;
		nameMap.set("Mute Channel", "_MuteChannel");
		_MuteChannel = false;
